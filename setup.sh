...
function setup_submodules
{
    ...
    for module in computor libft libftASM moulitest get_next_line ls_darwin ls_linux minishell 21sh
    do
    ...
    for setup in libft libftASM get_next_line ls_darwin ls_linux minishell 21sh
    do 
        bash ${setup}/setup.sh
    done
